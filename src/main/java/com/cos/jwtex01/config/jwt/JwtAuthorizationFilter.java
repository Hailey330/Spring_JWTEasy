...
//	@Autowired 내가 new 한 클래스는 autowired 가 아무것도 안먹음
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
		...
		// 내가 SecurityContext에 직접 접근해서 세션을 만들 떄 자동으로 UserDetailsService에 있는 loadUserByUsername을 찾음
		...
		// SecurityContextHolder.getContext().setAuthentication(authentication); // 세션 생성 완료
	}
}
